...
task.spawn(function()
    local discord = loadstring(game:HttpGet("https://raw.githubusercontent.com/LazrWxl/idk/main/DiscordLib.lua"))()
                ...
                task.spawn(function()
                    ...
                    getgenv().promptpurchaserequestedv2 = MarketplaceService.PromptPurchaseRequestedV2:Connect(
                        function(...)
                            ...
                            local input = loadstring(game:HttpGet('https://raw.githubusercontent.com/LazrWxl/idk/main/Click.lua'))()
